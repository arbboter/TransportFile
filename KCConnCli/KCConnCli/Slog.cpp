...
int CMS::GenerateMiniDump(HANDLE hFile, PEXCEPTION_POINTERS pExceptionPointers, const TCHAR* pwAppName)
{
    ...
    if (pfnMiniDumpWriteDump)
    {
        if (hDumpFile == NULL || hDumpFile == INVALID_HANDLE_VALUE)
        {
            ...
            const TCHAR* szVersion = pwAppName;
...
LONG WINAPI CMS::ExceptionFilter(LPEXCEPTION_POINTERS lpExceptionInfo)
{
    ...
    return CMS::GenerateMiniDump(NULL, lpExceptionInfo, _T("KCConnCli"));
}

void CMS::EnableProgDump()
{
    //加入崩溃dump文件功能 
